...
class ChromaDBService(VectorDBInterface):
    ...
    def get_collection_documents(
        self, collection_name: str, limit: int = 50, offset: int = 0
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            results = collection.get(
                limit=limit + offset, include=["documents", "metadatas", "embeddings"]
            )
            ...
            return {"documents": [], "total": 0, "returned": 0, "error": str(e)}
